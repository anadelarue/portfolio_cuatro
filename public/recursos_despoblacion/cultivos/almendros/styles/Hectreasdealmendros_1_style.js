...
var style_Hectreasdealmendros_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Hectáreas de almendros");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 37117.200000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 37117.200000 && value <= 74234.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 74234.400000 && value <= 111351.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 111351.600000 && value <= 148468.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 148468.800000 && value <= 185586.000000) {
            style = [ new ol.style.Style({
